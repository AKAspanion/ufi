...
const getSubSection = (obj) => {
  ...
  if (id == 1) {
    ...
    // console.log(commontext_h4);
    return (
      <>
        <div className={cs(styles.we__work__section, styles.discovery__workshop__sec, 'pt-0')}>
          <div className={cs([styles.common_text, styles.text__black])}>
            <h3 className={cs(styles.commonh3, 'mb-4')}>{commontext_h3}</h3>
            <h4 className={cs(styles.commonh4, 'mb-4')}>{commontext_h4}</h4>
          </div>
          <div
            className={cs(styles.workshop_wrap, [
              styles.black__bg__info,
              styles.common__pad__wrap,
            ])}>
            <div className={cs('row', 'm-0')}>
              ...
              <div
                className={cs([
                  ...
                  styles.box__down,
                  'p-0',
                  styles.mobile__white__bg,
                ])}>
                <div
                  className={cs([
                    styles.discovery__workshop__right,
                    styles.design__box,
                    styles.uipl_section_reveal_check,
                    styles.reveal_me,
                  ])}>
          ...
          <div
            className={cs(styles.workshop_wrap, [
              styles.white__bg__info,
              styles.common__padd__wrap,
            ])}>
            <div className={cs('row', 'm-0')}>
              {/* <div className={styles.discovery__workshop__head}>
                                {commontext_h4}
                            </div> */}
...
export default function Home() {
  ...
  if (contentRef.current) {
    ...
    barHeight = (Math.abs(contentDimensions.y - 900) / contentDimensions.height) * 100;
  ...
  return (
    <Layout darkHeader>
          ...
          <div className={cs('row', 'm-0')}>
            <div className={cs(['col-sm-11', 'col-md-10', 'col-lg-9', 'col-xl-7', 'p-0'])}>
              <div className={cs(styles.other__banner_text)}>
                ...
                <p>
                  The process is defined as a sequence of steps. When followed, it helps to achieve
                  a goal. We consider it - the art of thinking through.
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        className={cs([styles.scroll__section, styles.scrool__wrap, styles.scroll__main__wrap])}>
        <div className={cs([styles.scroll__left, styles.work__mobile__heading])}>
          <div className={cs(styles.common_text)}>
            <h3>Let’s talk about the specifics</h3>
          </div>
          <nav
            className={cs([styles.sidebar, { [styles.fixed]: isFixed }, styles.cd__vertical__nav])}>
            <ul>
                ...
                <li
                  ...
                  <a
                    className={cs([styles.a_link, styles.a__li], {
                      [styles.a__is__selected]: barHeight - 6 * index > (index + 1) * 10,
                    })}>
                    <span>{`${id}. ${name}`}</span>
                  </a>
                </li>
            ...
            <div className={cs(styles.header)}>
              <div className={cs(styles.progress__container)}>
                <div
                  className={cs(styles.progress__bar)}
                  id="myBar"
          ...
          <nav
            className={cs([styles.sidebar, styles.mobile__progressbar])}
            id="cd-vertical-nav-mobile">
            <ul>
              <li>
                <a
                  onClick={() => {
        ...
        <div ref={contentRef} className={cs([styles.scroll__right, styles.right__side__content])}>
          {process.map(
            (obj) =>
              obj.id == 1 && (
          ...
          <div key="2" id="section2">
            <section className={cs([styles.standout, styles.planning__sec])} key={`section2`}>
              <div
                className={cs([styles.common_text, styles.text__black, styles.planning__mobile])}>
                    ...
                    <div className={cs('row', 'm-0')}>
                      <div
                        ...
                        <div className={cs(styles.common__pad__left, styles.common__padd__left)}>
                          ...
                          <ul
                            className={cs([styles.text__white, styles.ul__list, styles.box__down])}>
                            <li>
                              <span>
                                Creation of all relevant documentation required for successful
                                execution of the project
                              </span>
                            </li>
                            <li>
                              <span>
                                Getting confirmation and approval from the client on the documents
                                and materials
                              </span>
                            </li>
                            <li>
                              <span>Defining the project plan</span>
                            </li>
                            <li>
                              <span>
                  ...
                  <div className={cs('row', 'm-0')}>
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div
                        ...
                        <ul className={cs([styles.text__black, styles.ul__list])}>
                          <li>
                            <span>
                              To get everything documented in detail, leaving nothing for chance or
                              assumption
                            </span>
                          </li>
                          <li>
                            <span>
                              To get client’s approval and signoff on the documentation and project
                              plan
                            </span>
                          </li>
                          <li>
                            <span>To have a well-defined and precise planning of the project </span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div className={cs(styles.common__pad__left, styles.common__padd__left)}>
                        ...
                        <ul className={cs([styles.text__black, styles.ul__list])}>
                          <li>
                            <span>Detailed technical Specification</span>
                          </li>
                          <li>
                          ...
                          <li>
                            <span>Project plan with detailed milestone/sprint planning</span>
                          </li>
                          <li>
                            <span>Test cases and scenarios</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div
                        ...
                        <ul className={cs([styles.text__black, styles.ul__list])}>
                          ...
                          <li>
                            <span>IA &amp; UX Lead</span>
                          </li>
                          <li>
                            <span>UI Design Lead</span>
                          </li>
                          <li>
                            <span>Test Lead</span>
                          </li>
          ...
          <div key="3" id="section3">
            <section
              ...
              <div
                className={cs([
                  'common__text__section',
                  styles.text__black,
                  styles.design__mobile,
                  styles.common_text,
                ])}>
              ...
              <div className={styles.we__work__section}>
                <div className={cs([styles.design__sec__wrap, styles.white__bg__info])}>
                  <div className={cs('row', 'm-0')}>
                    <div className={cs('col-sm-12', 'p-0')}>
                      <div
                        className={cs([
                          styles.discovery_workshop_right,
                          styles.design__box,
                          styles.uipl_section_reveal_check,
                          styles.reveal_me,
                        ])}>
                        <img
                          className={cs([styles.blur__out, styles.design__box_img])}
                          src="https://www.unifiedinfotech.net/assets/images/design@2x.jpg"
                          alt="Unified Infotech process"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div
                  ...
                  <div className={cs('row', 'm-0')}>
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div
                        className={cs(styles.common__pad__left, 'pt-0', styles.common__padd__left)}>
                        <div className={cs([styles.common_text, styles.text__black])}>
                          <h5>Objective</h5>
                        </div>
                        <ul className={cs([styles.text__black, styles.common__padd__left_ul])}>
                          <li>
                            <span>
                              UI Design of all the project screens based on the approved wire-frames
                              and design guidelines
                            </span>
                          </li>
                          <li>
                            <span>Web, Tablet and Mobile specific designs.</span>
                          </li>
                          <li>
                            <span>
                    ...
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div
                        ...
                        <ul className={cs([styles.text__black, styles.common__padd__left_ul])}>
                          <li>
                            <span>UI Designs of the projects</span>
                          </li>
                          <li>
                            <span>
                              ...
                              <a
                                ...
                                href="https://projects.invisionapp.com/share/95OUQVFHSJY#/screens/328514871"
                                target="_blank"
                                rel="noreferrer">
                                example link
                              </a>
                          ...
                          <li>
                            <span>Source files in either Photoshop or Sketch format</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div
                      className={cs('col-sm-12', 'col-lg-8', 'col-xl-7', styles.box__down, 'p-0')}>
                      <div className={cs(styles.common__pad__left, styles.common__padd__left)}>
                        <div className={cs([styles.common_text, styles.text__black])}>
                          <h5>Tools</h5>
                        </div>
                          ...
                          <div className={cs('col', 'pl-0')}>
                            <svg
                              ...
                              <g fill="none" fillRule="nonzero">
                                <path
                                  fill="#EA6C00"
                                  d="M7.914 11.71l10.648 20.842L.664 11.71zM29.214 11.71L18.566 32.552 36.464 11.71z"></path>
                                <path fill="#FDAD00" d="M7.914 11.71H29.21L18.562 32.552z"></path>
                                <path
                                  fill="#FDD231"
                                  d="M18.562.16L8.474 1.225l-.56 10.484zM18.562.16L28.65 1.225l.56 10.484z"></path>
                                <path
                                  fill="#FDAD00"
                                  d="M36.464 11.71l-7.81-10.484.56 10.484zM.664 11.71l7.81-10.484-.56 10.484z"></path>
                          ...
                          <div className={cs('col', 'pl-0')}>
                            <svg
                              ...
                              <g fill="none" fillRule="nonzero">
                                <path
                                  fill="#F11B5C"
                                  d="M32.627 0H3.973A3.173 3.173 0 0 0 .8 3.173v28.654A3.173 3.173 0 0 0 3.973 35h28.654a3.173 3.173 0 0 0 3.173-3.173V3.173A3.173 3.173 0 0 0 32.627 0"></path>
                                <path
                                  fill="#FFF"
                                  d="M12.497 11.012c1.163 0 2.138-.912 2.138-2.107 0-1.194-.975-2.106-2.138-2.106-1.164 0-2.138.912-2.138 2.106 0 1.195.974 2.107 2.138 2.107M8.064 22.294a7.236 7.236 0 0 0-.189 1.583c0 1.855 1.006 3.087 3.144 3.087 1.774 0 3.211-1.053 4.246-2.754l-.632 2.537h3.521l2.013-8.072c.503-2.043 1.478-3.104 2.956-3.104 1.163 0 1.886.723 1.886 1.918 0 .346-.031.723-.157 1.132l-1.038 3.71a5.577 5.577 0 0 0-.22 1.572c0 1.761 1.038 3.05 3.207 3.05 1.855 0 3.333-1.195 4.15-4.056l-1.383-.534c-.692 1.917-1.289 2.263-1.76 2.263-.472 0-.724-.314-.724-.942 0-.283.063-.597.157-.976l1.007-3.614a7.972 7.972 0 0 0 .346-2.293c0-2.704-1.636-4.115-3.616-4.115-1.855 0-3.742 1.673-4.685 3.434l.691-3.16h-5.376l-.755 2.783h2.516l-1.55 6.202c-1.216 2.704-3.45 2.748-3.73 2.685-.46-.104-.755-.279-.755-.877 0-.345.063-.841.22-1.439l2.358-9.355H7.938l-.755 2.784h2.484l-1.603 6.551"></path>
                              </g>
                            </svg>
                          </div>
                          <div className={cs('col', 'pl-0')}>
                            <svg
                              ...
                              <g fill="none" fillRule="nonzero">
                                <path
                                  fill="#FDBD39"
                                  d="M6.165 22.059l-2.092.764-.111 6.224 7.242-2.646c-2.486-.832-4.3-2.3-5.039-4.342"></path>
                                <path
                                  fill="#F69833"
                                  d="M7.26 15.477L0 18.129l4.073 4.696 2.092-.764c-.737-2.036-.282-4.334 1.095-6.584"></path>
                                <path
                                  fill="#FECF33"
                                  d="M19.477 6.494C10.232 9.871 4.27 16.841 6.165 22.06l33.478-12.23C37.748 4.613 28.72 3.119 19.477 6.495"></path>
                                <path
                                  fill="#EE6723"
                                  d="M26.33 25.396C35.575 22.019 41.545 15.08 39.64 9.83L6.164 22.06c1.904 5.251 10.921 6.714 20.166 3.337"></path>
                                <path
                                  fill="#F69833"
                                  d="M39.641 9.83L6.165 22.059c.655 1.808 3.156 2.699 6.663 2.699 3.42 0 7.797-.846 12.36-2.513C34.433 18.868 40.936 13.4 39.641 9.83"></path>
                                <path
                                  fill="#FDBD39"
                                  d="M32.979 7.133c-3.419 0-7.797.845-12.36 2.512C11.372 13.022 4.87 18.49 6.164 22.06l33.478-12.23c-.657-1.807-3.156-2.696-6.664-2.696"></path>
                                <g fill="#EE6723">
          ...
          <div key="4" id="section4">
            <section
              className={cs([
                styles.standout,
                styles.common__work__sec,
                styles.development__sec,
                styles.maintenance__sec,
              ])}>
              <div
                className={cs([
                  'common__text__section',
                  styles.text__black,
                  styles.development__mobile,
                  styles.common_text,
                ])}>
                  ...
                  <div className={cs('row', 'm-0')}>
                    <div
                      ...
                      <div
                        ...
                        <ul className={cs([styles.text__white, styles.common__padd__left_ul])}>
                          <li>
                            <span>
                              Catering the requirement for frontend, backend, web services, and API
                              development integration.
                            </span>
                          </li>
                          <li>
                            <span>Prepare a strategy for Agile Scrum methodology</span>
                          </li>
                          <li>
                            <span>
                          ...
                          <li>
                            <span>To set up a 2-3 week frequency for sprints/milestones</span>
                          </li>
                          <li>
                            <span>Crafting an optimized clean code structure</span>
                          </li>
                          <li>
                            <span>Involve client review in each sprint/milestone</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          className={cs([styles.blur__out, styles.design__box_img])}
                          src="https://www.unifiedinfotech.net/assets/images/development@2x.jpg"
                          alt="Unified Infotech process"
                        />
                      </div>
                    </div>
                  ...
                  <div className={cs('row', 'm-0')}>
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div className={cs([styles.common__pad__left, styles.common__padd__left])}>
                        ...
                        <ul className={cs([styles.text__black, styles.common__padd__left_ul])}>
                          <li>
                            <span>Back-end. : Laravel, Ruby, Python, Node.JS, Java</span>
                          </li>
                          <li>
                            <span>Front-end. : AngularJS, ReactJS, VueJS Html5, CSS</span>
                          </li>
                          <li>
                            <span>Database. : MongoDB, Mysql, PostgreSQL, Firebase</span>
                          </li>
                          <li>
                            <span>OpenSource : Drupal, Magento, Wordpress</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className={cs(['col-sm-8', 'p-0'])}>
                      <div className={cs([styles.common__pad__left, styles.common__padd__left])}>
                        ...
                        <ul className={cs([styles.text__black, styles.common__padd__left_ul])}>
                          <li>
                            <span>iOS : ObjectiveC, Swift, xCode</span>
                          </li>
                          <li>
                            <span>Android. : Java, Android studio</span>
                          </li>
                          <li>
                            <span>Hybrid. : Ionic, ReactNative</span>
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          <div key="5" id="section5">
            <section
              className={cs(['common__work__sec', styles.common__work__sec, styles.testing__sec])}
              key={`section5`}>
                  ...
                  <div className={cs('row', 'm-0')}>
                    <div className={cs(['col-md-12', 'col-lg-6', 'p-0'])}>
                      <div
                        ...
                        <ul className={cs([styles.text__white, styles.common__padd__left_ul])}>
                          <li>
                            <span>Product enhancement through an Agile approach</span>
                          </li>
                          <li>
                            <span>Regular Security Audits</span>
                          </li>
                          <li>
                            <span>Bi-weekly code back-ups</span>
                          </li>
                          <li>
                            <span>
                              Constant upgradation of the system based on new software/version
                              release
                            </span>
                          </li>
                          <li>
                            <span>
                              Full Testing the system each month to find any bugs, incompatibility
                              and error
                            </span>
                          </li>
                          <li>
                            <span>
                              Monitoring of the traffic and server load and optimizing according to
                              the business needs.{' '}
                            </span>
                          </li>
                        </ul>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          className={cs([styles.blur__out, styles.design__box_img])}
                          src="https://www.unifiedinfotech.net/assets/images/testing@2x.jpg"
                          alt="Unified Infotech process"
                        />
                      </div>
                    </div>
                        ...
                        <div className={cs('row', 'm-0')}>
                          <div className={cs(['col-4', styles.tools__col, 'pl-0'])}>
                            <div className={cs(styles.tools__img)}>
                              <img
                                ...
                                src="https://www.unifiedinfotech.net/assets/images/jira@2x.jpg"
                                alt="Unified Infotech process"
                              />
                            </div>
                          </div>
                          <div className={cs(['col-4', styles.tools__col, 'pl-0'])}>
                            <div className={cs(styles.tools__img)}>
                              <img
                                className={cs(styles.blur__out)}
                                src="https://www.unifiedinfotech.net/assets/images/mantis-bug-tracker-logo@2x.jpg"
                                alt="Unified Infotech process"
                              />
                            </div>
                          </div>
                          <div className={cs(['col-4', styles.tools__col, 'pl-0'])}>
                            <div className={cs(styles.tools__img)}>
                              <img
                                className={cs(styles.blur__out)}
                                src="https://www.unifiedinfotech.net/assets/images/firebase@2x.jpg"
                                alt="Unified Infotech process"
                              />
                            </div>
                          </div>
                          <div className={cs(['col-4', styles.tools__col, 'pl-0'])}>
                            <div className={cs(styles.tools__img)}>
                              <img
                                className={cs(styles.blur__out)}
                                src="https://www.unifiedinfotech.net/assets/images/jmeter@2x.jpg"
                                alt="Unified Infotech process"
                              />
                            </div>
                          </div>
                          <div className={cs(['col-4', styles.tools__col, 'pl-0'])}>
                            <div className={cs(styles.tools__img)}>
                              <img
                                className={cs(styles.blur__out)}
                                src="https://www.unifiedinfotech.net/assets/images/GTmetrix@2x.jpg"
                                alt="Unified Infotech process"
                              />
                            </div>
                          </div>
                          <div className={cs(['col-4', styles.tools__col, 'pl-0'])}>
                            <div className={cs(styles.tools__img)}>
                              <img
                                className={cs(styles.blur__out)}
                                src="https://www.unifiedinfotech.net/assets/images/se@2x.jpg"
                                alt="Unified Infotech process"
                              />
                            </div>
                          </div>
                  ...
                  <div className={cs('row', 'm-0')}>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          className={cs([styles.blur__out, styles.design__box_img])}
                          src="https://www.unifiedinfotech.net/assets/images/maintenance@2x.jpg"
                          alt="Unified Infotech process"
                        />
                      </div>
                    </div>
          ...
          <div className={cs('row')}>
            ...
            <div className={cs(['col-sm-6', 'col-md-6', 'col-lg-3', 'col-xl-3', 'mb-3'])}>
              <div
                ...
                <div
                  ...
                  <p className={cs(['list-text', styles.list__text])}>
                    {' '}
            ...
            <div className={cs(['col-sm-6', 'col-md-6', 'col-lg-3', 'col-xl-3', 'mb-3'])}>
              <div
                ...
                <div className={cs('card-body', styles.card__body)}>
                  <h5 className={cs(['card-title', styles.card__title])}>
                    {' '}
                    Weekly <span> Review</span>
                  </h5>
                </div>
                <ul className={cs(['list-group', styles.black__bg__info, styles.list__group])}>
                  <li
                    ...
                    {' '}
                    Weekly <span> 45 - 60 minutes</span>
                  </li>
                  <li
                    className={cs([
                      'list-group-item',
                ...
                <div className={cs('card-body', 'card-footer')}>
                  <p className={cs(['list-text', styles.list__text])}>
                    {' '}
                    Client along with the Project Manager & amp; Team Lead
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={cs('col-md-5')}>
              <div>
                <div className={cs([styles.common__text, styles.text__black, 'text-left'])}>
                  ...
                  <p>
                    We make sure to use the tools that are top of the market to bring your ideas
                    into reality. Our careful selection of tools makes sure that your ideas are
                    executed with the highest level of efficiency.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={cs('row')}>
                ...
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/slack@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/github@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/asana@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/invision@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/axure@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/zeplin@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/office365@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/zoom@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
                <div className={cs(['col-3', styles.tools__img__list])}>
                  <div className={cs(styles.tools__img)}>
                    <img
                      className={cs(styles.blur__out)}
                      src="https://www.unifiedinfotech.net/assets/images/skype@2x.jpg"
                      alt="Unified Infotech process"
                    />
                  </div>
                </div>
      ...
      <section
        className={cs([
          styles.work__common__sec,
          styles.collabotation__tools__sec,
          styles.collabotation__tools__sec__last,
        ])}>
        <div className={cs('container-fluid')}>
          <div className={cs('row')}>
            <div className={cs('col-md-5')}>
              <div>
                <div className={cs([styles.common__text, styles.text__black, 'text-left'])}>
                  ...
                  <p>
                    We aim to deliver excellence at every step of projects and finish our job with
                    the top level of efficiency and dedication.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className={cs(['panel', styles.panel__default, 'pt-0'])}>
                  <div className={cs(styles.panel__heading)} id="headingOne">
                    <h4 className={cs(styles.panel__title)}>
                      <a
                        className={cs(
                          { [styles.collapsed]: !collapsible.collapsible1 },
                          styles.a_link
                        )}
                        onClick={() => {
                          handleCollapse(1);
                  ...
                  <div
                    className={cs('panel-collapse', 'collapse', {
                      show: collapsible.collapsible1,
                    })}
                    id="collapseOne">
                    <div className={cs(styles.panel__body)}>
                      When the scope of your idea is not clear, we tend to go with the T&amp;M based
                      model to provide you with more efficiency as we continue with your project.{' '}
                    </div>
                  </div>
                </div>
                <div className={cs(['panel', styles.panel__default])}>
                  <div className={cs(styles.panel__heading)} id="headingOne">
                    <h4 className={cs(styles.panel__title)}>
                      <a
                        className={cs(
                          { [styles.collapsed]: !collapsible.collapsible2 },
                          styles.a_link
                        )}
                        onClick={() => {
                          handleCollapse(2);
                  ...
                  <div
                    ...
                    className={cs(
                      'panel-collapse',
                      'collapse',
                      { show: collapsible.collapsible2 },
                      { [styles.show__ease]: collapsible.collapsible2 }
                    )}>
                    <div className={cs(styles.panel__body)}>
                      To give you control over your project, the dedicated teams will be there at
                      your disposal. We aim to give you a sense of comfort as we work on your idea
                      and our dedicated teams make sure that you do feel that sense of control
                    </div>
                  </div>
                </div>
              </div>
