...
const proces_steps = [
    {
        1: {
            ...
            bg__info: {
                ...
                bgInfoWhite: {
                    uiplImage:
                        'https://www.unifiedinfotech.net/assets/images/discovery@4x.jpg',
                },
            },
        },
    },
                                    ...
                                    <>
                                        <div className={cs(['col-sm-8', 'p-0'])}>
                                            ...
                                            >
                                                ...
                                                <ul
                                                    className={cs([styles.text__black, styles.ul__list])}
                                                >
                                                    {list__data.map(desc => {
                                                        return (
                                                            <li>
...
export default function Home() {
    ...
    return (
        <Layout darkHeader>
                    ...
                    <div className={cs('row', 'm-0')}>
                        ...
                        >
                            <div className={cs(styles.other__banner_text)}>
                                ...
                                <p>
                                    The process is defined as a sequence of steps. When followed,
                                    it helps to achieve a goal. We consider it - the art of
                                    thinking through.
                </p>
                            </div>
                        </div>
            ...
            <section
                className={cs([
                    styles.scroll__section,
                    styles.scrool__wrap,
                    styles.scroll__main__wrap,
                ])}
            >
                <div
                    className={cs([styles.scroll__left, styles.work__mobile__heading])}
                >
                ...
                <div
                    ref={contentRef}
                    className={cs([styles.scroll__right, styles.right__side__content])}
                >
                    {process.map(
                        obj =>
                            obj.id == 1 && (
                        ...
                        >
                            ...
                            <div className={styles.planning__bg}>
                                <div className={styles.we__work__section}>
                                    <div
                                        className={
                                            (styles.common__pad__wrap, styles.common__padd__wrap)
                                        }
                                    >
                                        <div className={cs('row', 'm-0')}>
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <li>
                                                            <span>
                                                                Creation of all relevant documentation required
                                                                for successful execution of the project
                              </span>
                                                        </li>
                                                        <li>
                                                            <span>
                                                                Getting confirmation and approval from the
                                                                client on the documents and materials
                              </span>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <span>
                                                                Defining the design and branding guidelines of
                                                                the project
                              </span>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div className={cs(['col-sm-8', 'p-0'])}>
                                            ...
                                            >
                                                ...
                                                >
                                                    <li>
                                                        <span>
                                                            To get everything documented in detail, leaving
                                                            nothing for chance or assumption
                            </span>
                                                    </li>
                                                    <li>
                                                        <span>
                                                            To get client’s approval and signoff on the
                                                            documentation and project plan
                            </span>
                                                    </li>
                                                    <li>
                                                        <span>
                                                            To have a well-defined and precise planning of the
                              project{' '}
                                                        </span>
                                                    </li>
                                                </ul>
                                        ...
                                        <div className={cs(['col-sm-8', 'p-0'])}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <li>
                                                        <span>
                                                            Project plan with detailed milestone/sprint
                                                            planning
                            </span>
                                                    </li>
                                                    <li>
                                        ...
                                        <div className={cs(['col-sm-8', 'p-0'])}>
                                            ...
                                            >
                                                ...
                                                >
                                                    <h5 className={styles.sub__header}>
                                        ...
                                        <div className={cs(['col-sm-8', 'p-0'])}>
                                            ...
                                            >
                                                ...
                                                <ul
                                                    className={cs([
                                                        styles.text__black,
                                                        styles.common__padd__left_ul,
                                                    ])}
                                                >
                                                    <li>
                                                        <span>
                                                            UI Design of all the project screens based on the
                                                            approved wire-frames and design guidelines
                            </span>
                                                    </li>
                                                    <li>
                                                        <span>
                                                    ...
                                                    <li>
                                                        <span>
                                                            Getting system UI Designs approved and confirmed
                                                            by the client.
                            </span>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <div className={cs('col', 'pl-0')}>
                                                        ...
                                                        >
                                                            <g fill="none" fill-rule="nonzero">
                                                                <path
                                                                    fill="#261300"
                                                                    d="M1.7 1.5h33v32.1h-33z"
                                                                ></path>
                                                                <path
                                                                    fill="#FF7C00"
                                                                    d="M.2 0v35.1h36V0H.2zm1.5 1.5h33v32.1h-33V1.5z"
                                                                ></path>
                                                                <path
                                                                    fill="#FF7C00"
                                                    ...
                                                    <div className={cs('col', 'pl-0')}>
                                                        ...
                                                        >
                                                            <g fill="none" fill-rule="nonzero">
                                                                <path
                                                                    fill="#EA6C00"
                                                                    d="M7.914 11.71l10.648 20.842L.664 11.71zM29.214 11.71L18.566 32.552 36.464 11.71z"
                                                                ></path>
                                                                <path
                                                                    fill="#FDAD00"
                                                                    d="M7.914 11.71H29.21L18.562 32.552z"
                                                                ></path>
                                                                <path
                                                                    fill="#FDD231"
                                                                    d="M18.562.16L8.474 1.225l-.56 10.484zM18.562.16L28.65 1.225l.56 10.484z"
                                                                ></path>
                                                                <path
                                                                    fill="#FDAD00"
                                                                    d="M36.464 11.71l-7.81-10.484.56 10.484zM.664 11.71l7.81-10.484-.56 10.484z"
                                                                ></path>
                                                                <path
                                                                    fill="#FEEEB7"
                                                                    d="M18.562.16L7.914 11.71H29.21z"
                                                                ></path>
                                                            </g>
                                                        </svg>
                                                    </div>
                                                    ...
                                                    <div className={cs('col', 'pl-0')}>
                                                        ...
                                                        >
                                                            <g fill="none" fill-rule="nonzero">
                                                                <path
                                                                    fill="#FDBD39"
                                                                    d="M6.165 22.059l-2.092.764-.111 6.224 7.242-2.646c-2.486-.832-4.3-2.3-5.039-4.342"
                                                                ></path>
                                                                <path
                                                                    fill="#F69833"
                                                                    d="M7.26 15.477L0 18.129l4.073 4.696 2.092-.764c-.737-2.036-.282-4.334 1.095-6.584"
                                                                ></path>
                                                                <path
                                                                    fill="#FECF33"
                                                                    d="M19.477 6.494C10.232 9.871 4.27 16.841 6.165 22.06l33.478-12.23C37.748 4.613 28.72 3.119 19.477 6.495"
                                                                ></path>
                                                                <path
                                                                    fill="#EE6723"
                                                                    d="M26.33 25.396C35.575 22.019 41.545 15.08 39.64 9.83L6.164 22.06c1.904 5.251 10.921 6.714 20.166 3.337"
                                                                ></path>
                                                                <path
                                                                    fill="#F69833"
                                                                    d="M39.641 9.83L6.165 22.059c.655 1.808 3.156 2.699 6.663 2.699 3.42 0 7.797-.846 12.36-2.513C34.433 18.868 40.936 13.4 39.641 9.83"
                                                                ></path>
                                                                <path
                                                                    fill="#FDBD39"
                                                                    d="M32.979 7.133c-3.419 0-7.797.845-12.36 2.512C11.372 13.022 4.87 18.49 6.164 22.06l33.478-12.23c-.657-1.807-3.156-2.696-6.664-2.696"
                                                                ></path>
                                                                <g fill="#EE6723">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <li>
                                                        <span>
                                                            Catering the requirement for frontend, backend,
                                                            web services, and API development integration.
                            </span>
                                                    </li>
                                                    <li>
                                                        <span>
                                                    ...
                                                    <li>
                                                        <span>
                                                            Factor the aspects of multi-tenancy, scalability,
                                                            3rd party integration
                            </span>
                                                    </li>
                                                    <li>
                                                        <span>
                                                            To set up a 2-3 week frequency for
                                                            sprints/milestones
                            </span>
                                                    </li>
                                                    <li>
                                        ...
                                        <div className={cs(['col-md-12', 'col-lg-6', 'p-0'])}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <li>
                                                        <span>
                                                            Full Testing the system each month to find any
                                                            bugs, incompatibility and error
                            </span>
                                                    </li>
                                                    <li>
                                                        <span>
                                                            Monitoring of the traffic and server load and
                              optimizing according to the business needs.{' '}
                                                        </span>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div className={cs('row', 'm-0')}>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className={cs('row', 'm-0')}>
                                                    <div
                                                        className={cs(['col-4', styles.tools__col, 'pl-0'])}
                                                    >
                ...
                <div className={cs('container-fluid')}>
                    <div className={cs('row')}>
                        <div className={cs('col-12')}>
                            ...
                            >
                                <h3 className={cs('mb-5', styles.h3)}>
                                    {' '}
                    ...
                    <div className={cs('row')}>
                        <div className={cs('col-md-5')}>
                            <div>
                                ...
                                >
                                    <h3 className={cs('mb-3', styles.h3)}>
                                        {' '}
                    Collaboration Tools
                  </h3>
                                    <p>
                                        We make sure to use the tools that are top of the market to
                                        bring your ideas into reality. Our careful selection of
                                        tools makes sure that your ideas are executed with the
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <p>
                                        ...
                                        finish our job with the top level of efficiency and
                                        dedication.
                  </p>
                                </div>
                            </div>
                                ...
                                <div className={cs(['panel', styles.panel__default, 'pt-0'])}>
                                    ...
                                    >
                                        <div className={cs(styles.panel__body)}>
                                            When the scope of your idea is not clear, we tend to go
                                            with the T&amp;M based model to provide you with more
                      efficiency as we continue with your project.{' '}
                                        </div>
                                    </div>
                                </div>
                                <div className={cs(['panel', styles.panel__default])}>
                                    ...
                                    >
                                        <div className={cs(styles.panel__body)}>
                                            To give you control over your project, the dedicated teams
                                            will be there at your disposal. We aim to give you a sense
                                            of comfort as we work on your idea and our dedicated teams
                                            make sure that you do feel that sense of control
                    </div>
                                    </div>
                                </div>
                            </div>
