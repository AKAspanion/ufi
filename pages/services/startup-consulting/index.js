            ...
            <div className={cs('col-sm-11 col-md-10 col-lg-9 col-xl-8')}>
              <div className={cs(styles.others__banner__text)}>
                ...
                <h1 className={cs(styles.new__page__title)}>
                  <span>
                    Accelerate your business growth with the help of our guidance: choose our
                    startup consulting services to let your business grow bigger
                  </span>
                </h1>
              </div>
            </div>
        ...
        <div className={cs('container')}>
          <div className={cs('row')}>
            ...
            <div className={cs(['col-6', 'col-sm-6', 'col-md-6', styles.p__l__1])}>
              <div
                className={cs([
                  styles.consulting__radio__wrap,
                  styles.light__gray__bg__info,
                  styles.active__black,
                ])}>
                    ...
                    <div className={cs('label', styles.label)}>
                      <svg
                        ...
                        <g fill="none" fillRule="evenodd">
                          ...
                          <path stroke="#000" strokeWidth="3" d="M3 10.16L7.566 15 17 5"></path>
                        </g>
                      </svg>
      ...
      <div id="StartUp" className={cs(styles.consulting__start__add1)}>
        <div className={cs(styles.consulting__banner)}>
          <img
            ...
            src="https://www.unifiedinfotech.net/assets/images/banner-start-up@1x.jpg"
            ...
            <div
              ...
              <div className={cs([styles.consulting__up__wrap, styles.black__bg__info])}>
                <div className={cs([styles.common__text, styles.text__white])}>
                  ...
                  <p>
                    We offer unique expertise that blends diverse entrepreneurial experience,
                    practical solutions, and real business insights in our startup consulting
                    services. We help you to identify the most critical next steps, help them get
                    executed and advice for greater return on investment. Check out what’s in our
          ...
          <div className={cs(['row', 'justify-content-center', 'm-0'])}>
            <div className={cs(['col-sm-12', 'col-lg-6', 'col-xl-5', 'pr-10'])}>
              <div className={cs([styles.message__text__wrap])}>
                <div
                  ...
                  <p>
                    We ask the big questions starting from who is your customer, what problems you
                    are trying to solve, how does your product solve the market problem and what are
                    the key features that might give you a headstart.
                  </p>
                  <p>
                    We encourage you to start with a business model canvas which is a one-page
                    strategy consulting for startups describing the high-level strategic details of
                    your product vision.
                  </p>
                </div>
              </div>
            ...
            <div className={cs(['col-sm-12', 'col-lg-6', 'col-xl-7', 'p-0'])}>
              <div
                ...
                <img
                  className={cs(styles.blur__out)}
                  src="https://www.unifiedinfotech.net/assets/images/validate-build@1x.jpg"
                  alt="startup consulting services"
                />
              </div>
            </div>
          ...
          <div className={cs(['row', 'justify-content-center', 'flex-row-reverse', 'm-0'])}>
            <div className={cs(['col-sm-12', 'col-lg-6', 'col-xl-5', 'pr-10'])}>
              <div className={cs(styles.message__text__wrap)}>
                <div
                  ...
                  <p>
                    It is the potential buyers of your product to start with for lean market
                    validation. As one of the trusted startup consulting firms, we know the
                    struggles of startups. Hence we recommend after you pen down your assumption
                    list, reach out to a sample of your potential audience to check if they
                    resonate. A few well-phrased questions can yield interesting customer insights
                  </p>
                </div>
              </div>
            </div>
            <div className={cs(['col-sm-12', 'col-lg-6', 'col-xl-7', 'p-0'])}>
              <div
                ...
                <img
                  className={cs(styles.blur__out)}
                  src="https://www.unifiedinfotech.net/assets/images/assumptions@1x.jpg"
                  alt="startup consulting services"
                />
              </div>
            </div>
              ...
              <div
                ...
                <div
                  ...
                  <div className={cs([styles.common__text, styles.text__white])}>
                    ...
                    <p>
                      We help you craft a compelling value proposition being one of the most
                      important steps in developing your product and business. We include this step
                      in our small business consulting services. In essence, your value proposition
                      should always:
                    </p>
                  </div>
                  <ul className={cs(styles.text__white)}>
                    <li>
                      <span>explain the problem your product solves or the value it offers.</span>
                    </li>
                    <li>
                      <span>directly speak to your customer</span>
                    </li>
                    <li>
                      <span>
                        pass the “so what” test answering why your customer should care for your
                        product
                      </span>
                    </li>
                  </ul>
          ...
          <div className={cs(['row', 'justify-content-center', 'm-0'])}>
            <div className={cs(['col-sm-12', 'col-lg-6', 'col-xl-5', 'pr-10'])}>
              <div
                ...
                <div
                  ...
                  <p>
                    A roadmap is a strategic-level blueprint for converting your value proposition
                    into a product. Think about your roadmap and milestones, not just in terms of
                    feature list but from customer value stand-point. A few minutes of research
                    based on the data gathered on your target audiences’ persona help you prioritize
                    features and fixes.
                  </p>
                </div>
              </div>
            ...
            <div className={cs(['col-sm-12', 'col-lg-6', 'col-xl-7', 'p-0'])}>
              <div
                ...
                <img
                  className={cs(styles.blur__out)}
                  src="https://www.unifiedinfotech.net/assets/images/translate@1x.jpg"
                  alt="startup consulting services"
                />
              </div>
            </div>
            ...
            <div className={cs(['col-sm-12', 'col-md-8', 'col-lg-7', 'col-xl-6'])}>
              <div className={cs(styles.message__text__wrap)}>
                <div
                  ...
                  <p>
                    From a naive business idea on a scribble pad to a solid document articulating
                    feature scoping, use cases and milestone definition, we lay out the scope of
                    your project along with your collaboration. And this helps in making lesser
                    mistakes in the journey. This makes clients trust us one of the leading startup
        ...
        <div className={cs('row')}>
          <div className={cs('col-sm-12')}>
            <div className={cs(styles.consulting__planning__img)}>
              <img
                className={styles.blur__out}
                src="https://www.unifiedinfotech.net/assets/images/ideation-doc@1x.jpg"
                alt="startup consulting services"
              />
            </div>
          </div>
            ...
            {consult_add.map(({ title, description }) => (
              <div className={cs(['col-12', 'col-sm-12', 'col-md-4', 'col-lg-4', 'r-p-0'])}>
                <div
                  ...
                  <div
                    className={cs([styles.box__bottom, styles.common__text, styles.text__black])}>
                    <p>{description}</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className={cs([styles.work__project__info, styles.content__col])}>
                    <a href="https://www.unifiedinfotech.net/portfolio/toonyport/">
                      <div
                        ...
                        <img
                          className={cs([styles.blur__out])}
                          src="https://www.unifiedinfotech.net/assets/images/toonyport-ecommerce@1x.jpg"
                          alt="startup consulting services"
                        />
                      </div>
                    </a>
                    <div className={cs([styles.work__project__text])}>
                      ...
                      <div className={cs([styles.project__text__desc])}>
                        <h3>
                          Co-created with this e-commerce startup to be the one stop solution for
                          kids apparel and accessories, making shopping easy and time saving
                        </h3>
                      </div>
