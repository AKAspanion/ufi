  ...
  return (
    <Layout darkHeader>
      <Head>
                ...
                <div className={cs("row justify-content-start")}>
                    <div className={cs("col-sm-11 col-md-10 col-lg-9 col-xl-8")}>
                        <div className={cs(styles.others__banner__text)}>
                            ...
                            <h1 className={cs(styles.new__page__title)}><span>We leverage the mobile device capabilities to create a memorable end-user experience to spur your brand’s growth. A trusted mobile app development company for world-class brands.</span></h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className={cs(mobileStyles.mobile__app__sec__1)}>
            <div className={cs(['container-fluid', 'p-0'])}>
                <div className={cs(['row','m-0'])}>
                    <div id="StartUp" className={cs([styles.consulting__start__add1, mobileStyles.app__sec__img])}>
        ...
        <section class={cs([mobileStyles.mobile__app__sec__2])}>
                ...
                <div class={cs(['row', 'm-0'])}>
                    ...
                    <div class={cs(['col-md-4', 'align-self-center', 'p-0'])}>
                        <div class={cs([mobileStyles.mobility__right])}>
                            <div class={cs([mobileStyles.item__right__top, 'aos-init','aos-animate'])} data-aos="fade-down-left">
                                <div class={cs([mobileStyles.item__box__top])}></div>
                            </div>
                            <div class={cs([mobileStyles.item__right__down, 'aos-init','aos-animate'])} data-aos="fade-up-right">
        ...
        <section className={cs([mobileStyles.mobile__app__sec__6, mobileStyles.mobile__app__responsive, mobileStyles.mobile__app__development__we__develop,'aos-init', 'aos-animate'])} data-aos="fade-up" data-aos-delay="200">
                <div className={cs(['container-fluid','p-0'])}>
                        <div className={cs(['row', 'm-0', 'justify-content-center'])}>
                             ...
                             {whatWeDevelop.map(({ title, maintext, link, icon }, index) => ( <div className={cs(['col-12', 'col-sm-6', 'col-md-6', 'col-lg-6', 'col-xl-3', 'mb-4', mobileStyles.align__end, mobileStyles.border__end, mobileStyles.pad__box])}>
                                 <a href={link}>
                                 <div className={cs([mobileStyles.card__box, mobileStyles.box__container, mobileStyles.box__dark, mobileStyles.on__hover__show__content])}>
                                     <div className={cs([mobileStyles.box__top, mobileStyles.common__text, {[styles.text__black__h1]: index%2 ==0} ])}>
                                         <h2 className={cs(mobileStyles.h2)}>{title}</h2>
                                     </div>
                                     <div className={cs([mobileStyles.box__bottom])}>
                                         <div className={cs([mobileStyles.icon, {[styles.text__black__h1]: index%2 ==0}])}>
                                            {icon}
                                         </div>
                                     </div>
                                     <div className={cs([mobileStyles.card__box__footer])}>
                                         <div className={cs([mobileStyles.info])}>
                                            <p className={cs([mobileStyles.hover__text, {[styles.text__black__h1]: index%2 ==0}])}>{maintext}</p>
                                         </div>
                                     </div>
                  ...
                  <div className={cs(['row', 'flex__row__reverse', 'justify-content-center'])}>         
                      ...
                      <div className={cs(['col-sm-12', 'col-md-6'])}>
                          <div className={cs([styles.message__text__wrap, 'aos-init', 'aos-animate', mobileStyles.message__text__wrap])} data-aos="fade-up">
                              <div className={cs([styles.text__message__info, styles.common__text, styles.text__black__h1])}>
                ...
                <div className={cs(['container-fluid', 'p-0'])}>
                  <div className={cs(['row', 'm-0', 'justify-content-left'])}>         
                      <div className={cs(['col-sm-12', 'col-md-12', 'col-lg-4', 'col-xl-5', 'p-0'])}>
                          <div className={cs([styles.message__text__wrap, 'p-2', 'aos-init', 'aos-animate', mobileStyles.message__text__wrap])} data-aos="fade-up">
                              <div className={cs([styles.text__message__info, styles.common__text, styles.text__white])}>
                ...
                <div className={cs(['row', 'm-0'])}>
                    <div className={cs(['col-sm-12', 'p-0'])}>
                        ...
                        {practicesWeFollow.map(({ id, title, imgSrc, subHeader, para }, index) => (
                            <div key={id}>
                            <h3 className={cs([styles.h4, mobileStyles.h4, {[mobileStyles.active] : collapsible.activeId==id}])} onClick={() => {
                                                    handleCollapse(id);
                                                }}>{title}</h3>
                            <div className={cs([mobileStyles.tab__right__side, {[mobileStyles.active] : collapsible.activeId==id} , mobileStyles.noafter])}>
