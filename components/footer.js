      ...
      <div className={styles.footer}>
        <div className={cs(styles.row, styles.row__left)}>
          ...
          <div className={styles.visit}>
            <div className={cs(styles.visit__text, styles.visit__text__tilte)}>
              Visit us at
            </div>
      ...
      <div className={styles.footer__bottom}>
        <div className={styles.footer__bottom__container}>
          <div className={styles.footer__terms}>
            ...
            <span className={styles.gap}> | </span> <a> Privacy Policy</a>{' '}
            <span className={styles.gap}> | </span> <a>Sitemap</a>
          </div>
          <div className={styles.footer__copyright}>
            <p>© 2021 XYZ Inc. All rights reserved.</p>
          </div>
          <div className={styles.footer__madewithlove}>
            Made with ♥ in India
          </div>
        </div>
      </div>
