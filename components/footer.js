  ...
  return (
    <footer className={styles.footer__wrapper}>
      <div className={styles.footer}>
        <div className={cs(styles.row, styles.row__left)}>
          ...
          <div className={styles.visit}>
            <div className={cs(styles.visit__text, styles.visit__text__tilte)}>Visit us at</div>
            <div className={styles.visit__text}>
              <span className={styles.flag}>
                <img
                  src="https://www.unifiedinfotech.net/assets/images/icon/Flag-USA.svg"
                  alt="USA Flag"
                />
              </span>
              ABC, Random Avenue, New York, NY 24513
            </div>
            <div className={styles.visit__text}>
              <span className={styles.flag}>
                <img
                  src="https://www.unifiedinfotech.net/assets/images/icon/Flag-India.svg"
                  alt="Indian Flag"
                />
              </span>
              XYZ, Salt Lake City, Sec V, Kol-700091
            </div>
          </div>
                ...
                <a target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 17">
                    <path
                      fill="#ffffff"
                      fillRule="nonzero"
                      d="M5.323 5.57V4.106c0-.22.01-.39.031-.511a.986.986 0 0 1 .14-.356.574.574 0 0 1 .355-.242c.163-.045.38-.068.651-.068h1.48V0H5.614C4.247 0 3.264.321 2.667.964s-.896 1.59-.896 2.842V5.57H0V8.5h1.77V17h3.553V8.5h2.364L8 5.57H5.323z"></path>
                  </svg>
                </a>
              </li>
              <li>
        ...
        <div className={cs(styles.row, styles.row__right)}>
          <img
      ...
      <div className={styles.footer__bottom}>
        <div className={styles.footer__bottom__container}>
          <div className={styles.footer__terms}>
            <a>Terms &amp; Conditions </a> <span className={styles.gap}> | </span>{' '}
            <a> Privacy Policy</a> <span className={styles.gap}> | </span> <a>Sitemap</a>
          </div>
          <div className={styles.footer__copyright}>
            <p>© 2021 XYZ Inc. All rights reserved.</p>
          </div>
          <div className={styles.footer__madewithlove}>Made with ♥ in India</div>
        </div>
      </div>
    </footer>
  );
